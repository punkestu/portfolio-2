    ...
    <section className="w-screen h-screen flex justify-center items-center">
      <div className="group relative pb-10">
        ...
        >
          ...
          <div className="w-80 h-24 bg-amber-100/75 mt-3 rounded relative flex items-center justify-center">
            <img src={Hero} alt="hero" className="absolute -translate-y-1.5" />
          </div>
        </div>
        <div
          id="portfolios"
        ...
        >
          ...
          <a href="https://www.linkedin.com/in/bpangestu/" target="_blank" rel="noopener noreferrer">
            <svg
              className="w-8 h-8"
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
